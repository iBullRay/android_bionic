...
enum v4l2_white_balance_temperature {
    V4L2_WHITE_BALANCE_INCANDESCENT     = 0, /* °×³ã¹â */
    V4L2_WHITE_BALANCE_FLUORESCENT      = 1, /* Ó«¹âµÆ */
    V4L2_WHITE_BALANCE_DAYLIGHT         = 2, /* ÈÕ¹â */
    V4L2_WHITE_BALANCE_CLOUDY_DAYLIGHT  = 3, /* ¶àÔÆ */
    V4L2_WHITE_BALANCE_WARM_FLUORESCENT = 4, /* Å¯Ó«¹âµÆ */
    V4L2_WHITE_BALANCE_TWILIGHT         = 5, /* »Æ»è */
    V4L2_WHITE_BALANCE_SHADE            = 6, /* ÒõÓ° */
};
